...
describe('method loading', () => {
    ...
    it('has usable methods on other methods', () => {
        ...
        registerHapi(hapiServer, {
            ...
            expect(hapiServer.methods.sample2Method.add(testValueX, testValueY)).to.be.equal(hapiServer.methods.sample3Method.useAdd(testValueX, testValueY));
        });
    });
            ...
            methods: [
                {
                    prefix: 'main',
                    includes: [
                        'methods/subdir/*2Method.js'
                    ]
                },
                {
                    prefix: 'sub',
                    includes: [
                        'methods/subdir/*4Method.js'
                    ]
                }
            ]
        }).then((resolved) => {
    ...
    it('has usable method and options exporting methods with prefix', () => {
        ...
        registerHapi(hapiServer, {
            ...
            expect(hapiServer.methods.minor.sample6Method(8).then((res) => {
                expect(res).to.equal({
                    addToSelf: 16,
                    counter: 3
                });
    ...
    it('has usable method and options exporting methods with prefix using direct inject', () => {
        ...
        registerHapi(hapiServer, {
            ...
            expect(hapiServer.methods.minor.sample6MethodX(8).then((res) => {
    ...
    it('is able to use method with options within other methods', () => {
        ...
        registerHapi(hapiServer, {
            methods: [
                {
                    includes: [
                        'methods/subdir/sample8Method.js'
                    ],
                    options: {
                        bind: {
                            operation: function (a) {
    ...
    it('merges loaded options from methods', () => {
        ...
        registerHapi(hapiServer, {
            methods: [
                {
                    includes: [
                        'methods/subdir/sample2Method.js'
                    ],
                    options: {
                        cache: {
                            expiresIn: 60000,
