...
describe('bind loading', () => {
    ...
    it('has usable autoloaded binds with included routes and handlers', (done) => {
    ...
    it('has usable autoloaded binds separate loading of routes', (done) => {
