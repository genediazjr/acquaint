                ...
                return FunctionHelper.getItems(injectItem).then((items) => {
                    ...
                    return FunctionHelper.executeEach(items, (item) => {
                        ...
                        return Async.forEachOf(injectModule, (injectModuleValue, injectModuleKey, nextInjectModuleKey) => {
                            ...
                            FunctionHelper.methodInjectHelper(server, methods, methodsFilename, injectItem.prefix, injectItem.options, injectModule, injectModuleKey);
                ...
                return FunctionHelper.getItems(injectItem).then((items) => {
                    ...
                    return FunctionHelper.executeEach(items, (item) => {
                        ...
                        if (Joi.string().validate(item).error) {
                            ...
                            server.handler(Path.basename(item, Path.extname(item)), require(FunctionHelper.relativeTo + '/' + item));
